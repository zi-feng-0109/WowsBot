...
RIBBON_DISPLAY = {
    ...
    "TORPEDO_PROTECTION_HIT":    ("鱼防",     "ribbon_torpedo"),
    "SECONDARY_CALIBER":         ("副炮",     "ribbon_main_caliber"),
    ...
    "BUILDING_KILL":             ("建筑",     "ribbon_building_kill"),
    "BASE_DEFENSE":              ("守点",     "ribbon_base_defense"),
    "BASE_CAPTURE":              ("占点",     "ribbon_base_capture"),
    "BASE_CAPTURE_ASSIST":       ("协占",     "ribbon_base_capture_assist"),
    "ASSIST":                    ("协同",     "ribbon_assist"),
    "BOMB":                      ("炸弹",     "ribbon_bomb"),
    ...
    "SUPPRESSED":                ("压制",     "ribbon_crit"),
    "BULGE":                     ("撞墙",     "ribbon_main_caliber"),
