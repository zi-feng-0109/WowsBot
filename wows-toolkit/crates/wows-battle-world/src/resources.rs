...
pub struct SelfStats {
    ...
    /// Self-player achievement counts by GameParams achievement id, from
    /// `onAchievementEarned`. Self-only (fired on the recording player's avatar).
    pub achievements: HashMap<i64, i64>,
}
